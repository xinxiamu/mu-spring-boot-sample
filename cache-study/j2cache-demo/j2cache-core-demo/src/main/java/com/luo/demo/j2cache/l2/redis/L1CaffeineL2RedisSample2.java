package com.luo.demo.j2cache.l2.redis;

import com.luo.demo.j2cache.base.J2CacheBaseSample;
import lombok.extern.slf4j.Slf4j;

/**
 * J2cache L1 Caffeine, L2 Redis(Jedis)缓存示例
 *
 * @author luohq
 * @date 2022-04-03 11:57
 */
@Slf4j
public class L1CaffeineL2RedisSample2 {
    public static void main(String[] args) throws Exception {
        String j2CachePropsPath = "/j2cache-l1-caffeine-l2-redis.properties";
