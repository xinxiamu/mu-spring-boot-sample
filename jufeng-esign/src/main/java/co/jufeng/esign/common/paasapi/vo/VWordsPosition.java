...
@NoArgsConstructor
@Data
public class VWordsPosition implements Serializable {
    private static final long serialVersionUID = -7160888527852045892L;

    /**
     * code : 0
     * message : 成功
     * data : [{"keyword":"方法","fileId":"b4f3d89420ec438ab83e8a02cabf1342","positionList":[{"pageIndex":1,"coordinateList":[{"posx":315.43,"posy":185.65723}]}]}]
     */
